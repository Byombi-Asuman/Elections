...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const home = data.user.role === 'STUDENT' ? '/student/dashboard' : '/admin/dashboard';
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="max-w-md">
            ...
            <div className="mt-8 flex gap-8">
              ...
              <div>
                <p className="text-2xl font-bold font-display">Real-time</p>
                <p className="text-sm text-primary-200">Results</p>
              </div>
              <div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 p-4 rounded-xl bg-slate-100 border border-slate-200">
            ...
            <div className="space-y-1 text-xs text-slate-500 font-mono">
              ...
              <p>james.wilson@school.edu / Student@123</p>
            </div>
          </div>
        </div>
      </div>
